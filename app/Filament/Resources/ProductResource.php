        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Совместимость с авто')
                    ->description('Марка и модель — из справочника «Автомобили». Если доступны «Записи из справочника», выберите строки с годами и уточните применимость в мультивыборе лет. Если списка нет — годы только вручную, формат см. под полем (поколение кузова в это поле не вводится). OEM по строкам — во вкладке «Совместимость с автомобилями».')
                    ->schema([
