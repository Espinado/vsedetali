        ...
        return $form
            ->schema([
                Forms\Components\Section::make()
                    ->description('Остаток, резерв и срок на складе — по каждому активному складу отдельная строка. Склад без продавца — площадка; с продавцом — склад этого продавца (склады продавца — во вкладке «Склады» в карточке продавца).')
                    ->schema([
