        ...
        return $form
            ->schema([
                Forms\Components\Section::make()
                    ->description('Все поля обязательны. При создании позиция уходит на модерацию; при редактировании обновляются карточка товара в каталоге (название, фото, совместимость, адрес карточки) и поля площадки. Совместимость — несколько строк «марка / модель / годы». Ошибки проверки показываются под полями и вверху формы.')
                    ->schema([
