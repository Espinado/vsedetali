...
<div class="max-w-md mx-auto">
    <h1 class="text-2xl font-bold mb-2">Пароль для кабинета продавца</h1>
    ...
    <form method="POST" action="{{ route('seller-staff.invite.update', ['token' => $token]) }}" class="space-y-4 bg-white rounded-lg border border-slate-200 p-6">
        @csrf
        <div>
