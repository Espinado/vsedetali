...
<div class="mx-auto max-w-md min-w-0">
    <h1 class="mb-2 text-xl font-bold sm:text-2xl">Пароль для кабинета продавца</h1>
    ...
    <form method="POST" action="{{ route('seller-staff.invite.update', ['token' => $token]) }}" class="space-y-4 rounded-lg border border-slate-200 bg-white p-4 sm:p-6">
        @csrf
        <div>
