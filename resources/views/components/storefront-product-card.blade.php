...
@else
    ...
    @endphp
    <div {{ $attributes->merge(['class' => 'card-store-product flex h-full min-h-0 flex-col overflow-hidden md:grid md:grid-cols-[minmax(11rem,15.5rem)_1fr] md:gap-0 lg:grid-cols-[minmax(12rem,17rem)_1fr]']) }}>
        <a href="{{ route('product.show', $product) }}"
