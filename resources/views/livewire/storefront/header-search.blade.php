<div class="relative w-full max-w-xl">
    <form wire:submit.prevent="search" class="relative">
        <input
            ...
            class="w-full rounded-lg border border-slate-300 bg-slate-50 px-4 py-2.5 pr-20 text-sm shadow-sm focus:border-indigo-500 focus:bg-white focus:ring-indigo-500"
        >
        ...
        @if ($query !== '')
            <button
                ...
                class="absolute right-12 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600"
        ...
        <button
            type="submit"
            class="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-medium text-slate-600 hover:text-slate-900"
        >
            Найти
        </button>
    </form>
