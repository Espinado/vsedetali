<div>
    <h1 class="mb-4 text-xl font-bold text-slate-900 sm:mb-6 sm:text-2xl">Корзина</h1>
    ...
    @else
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <div class="flex items-center gap-1">
                                <input type="number"
                                       ...
                                       class="h-11 w-20 rounded border-slate-300 text-center text-sm shadow-sm">
                            </div>
                            <span class="min-w-[6rem] text-right font-medium text-slate-900">
                            ...
                            <button type="button"
                                    ...
                                    title="Удалить">
                                <svg class="mx-auto h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                            </button>
                        </div>
                    </li>
                @endforeach
        ...
        <div class="mt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('checkout') }}" class="btn-store-cta w-full text-center sm:w-auto">
                Оформить заказ
            </a>
        </div>
    @endif
