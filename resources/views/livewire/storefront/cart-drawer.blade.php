        ...
        <div class="fixed inset-0 z-[70]">
            ...
            <div class="absolute right-0 top-0 flex h-full w-full max-w-md flex-col bg-white shadow-2xl">
                <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                    ...
                    <button type="button" wire:click="closeDrawer" class="text-slate-400 hover:text-slate-600">
                ...
                @if($this->items->isEmpty())
                    <div class="flex flex-1 flex-col items-center justify-center px-6 text-center">
                        ...
                        <button type="button" wire:click="closeDrawer" class="mt-6 rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-white hover:bg-slate-700">
                            Продолжить покупки
                        </button>
                    </div>
                @else
                    ...
                    <div class="border-t border-slate-200 px-5 py-4">
                        ...
                        <div class="grid gap-3">
                            <a href="{{ route('cart') }}" class="inline-flex justify-center rounded-lg border border-slate-300 px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50">
                                Перейти в корзину
                            </a>
                            <a href="{{ route('checkout') }}" class="inline-flex justify-center rounded-lg bg-indigo-600 px-4 py-3 text-sm font-medium text-white hover:bg-indigo-700">
                                Оформить заказ
                            </a>
                        </div>
                    </div>
